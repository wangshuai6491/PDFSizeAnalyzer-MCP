...
def process_images(input_dir,rotation_angle,target_width,target_height,lock_aspect_ratio=False,process_subfolders=False,target_dpi=300,preserve_exif=True,progress=None):
    """
...
# 用户可直接输入文件夹路径
folder = st.text_input("请输入文件夹路径（回车确认）")
